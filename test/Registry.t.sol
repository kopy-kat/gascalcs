...
import {
    BaseTest, RegistryTestLib, RegistryInstance
} from "../lib/registry/test/utils/BaseTest.t.sol";
import { IERC7484 } from "registry/interface/IERC7484.sol";
...
contract RegistryTest is BaseTest {
    ...
    function testGasCheck() public {
        ...
        console.log("Rhinestone Registry check: %s", gasCheck);
        console.log("Minimal 7484 Registry check: %s", gasCheckMinimal7484);
    }
    ...
    function testGasCheckN__Given__TwoAttesters() public {
        ...
        console.log("Rhinestone Registry checkN (2): %s", gasCheck);
        console.log("Minimal 7484 Registry check (2): %s", gasCheckMinimal7484);
    }
    ...
    function testGasCheckN__Given__ThreeAttesters() public {
        ...
        console.log("Rhinestone Registry checkN (3): %s", gasCheck);
        console.log("Minimal 7484 Registry check (3): %s", gasCheckMinimal7484);
    }
}
